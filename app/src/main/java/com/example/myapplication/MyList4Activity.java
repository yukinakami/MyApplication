...
public class MyList4Activity extends AppCompatActivity {
    Handler handler;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mylist4);
        ...
        handler = new Handler(Looper.myLooper())
        {
            ...
            public void handleMessage(@NonNull Message msg)
            {
                if(msg.what == 7)
                {
                    ...
                    ListAdapter adapter = new ArrayAdapter<String>(MyList4Activity.this, android.R.layout.simple_list_item_1,list2);
